...
public class ConsultaPessoas {
    ...
    public static Map<String, Double> obterMediaSalarioPorCargo(List<Pessoa> todasPessoas) {
        ...
        return todasPessoas.stream()
                .collect(Collectors.groupingBy(
                        Pessoa::getCargo,              // agrupa por cargo
                        Collectors.averagingDouble(Pessoa::getSalario) // calcula a média de salário
                ));
    }
        ...
        return todasPessoas.stream()
                .collect(Collectors.groupingBy(
                        ...
                        Collectors.flatMapping(
                                p -> p.getHobbies().stream(),   // extrai os hobbies de cada pessoa
                                Collectors.toCollection(TreeSet::new) // coleta em TreeSet
                        )
                ));
    }
}
